...
Key Insights
* Financial Growth: Achieved a total revenue of $159,383,368, representing a 26.23% increase over the previous period.

* Sales Volume: Sold over 53.6 million units, a 27.34% increase in quantity.

* Top Products: Mixing bowls led as the top revenue generator ($4.5M+), while Teapots saw the highest sum of quantity sold (~1.98M units).

* Regional Performance: Texas and Washington emerged as the top-performing states by revenue.
